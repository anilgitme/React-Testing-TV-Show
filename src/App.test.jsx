...
test('renders data with no errors', async () => {
    ...
    expect(/Stranger Things/i).toBeDefined()

// const role = screen.getByText('Select an option');
//   userEvent.click(role);
//   const seasons = await waitFor(() => screen.getAllByTestId("Select a season"))
